...
const Server = require('../protocol/mqtt/mqttServer');
...
class MasterAgent extends EventEmitter {
    ...
    listen(port, cb) {
        ...
        this.server.on('connection', (socket) => {
            let masterSocket = new MasterSocket(this, socket);
    ...
    doAuthServer(msg, socket, cb) {
        ...
        this.consoleService.authServer(msg, env, (status) => {
            ...
            let record = this.addConnection(this, msg.id, msg.serverType, msg.pid, msg.info, socket);
