var logger = require('pofresh-logger').getLogger('pofresh-admin', 'MonitorAgent');
var Client = require('../protocol/socketio/sioClient');
...
MonitorAgent.prototype.connect = function (port, host, cb) {
    ...
    this.socket.on('reconnect', function () {
        ...
        self.socket.send('reconnect', req);
    });
